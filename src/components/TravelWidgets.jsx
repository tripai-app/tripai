...
const DOS_DONTS_DB = {
  japan:        { dos: ['Schuhe ausziehen beim Betreten von Häusern','Mit beiden Händen Visitenkarten überreichen','Vor dem Essen „Itadakimasu" sagen','In Ryokans den Yukata (Kimono) korrekt tragen'], donts: ['Kein Trinkgeld geben — gilt als Beleidigung!','Nie Essstäbchen senkrecht in Reis stecken (Trauersymbol)','Nicht trinkend auf der Straße herumlaufen','Nie laut in Zügen & U-Bahnen telefonieren'] },
  thai:         { dos: ['Beim Betreten von Tempeln Schuhe ausziehen & bedecken','Wai-Geste (Hände gefaltet) zur Begrüßung','Buddha-Statuen respektvoll behandeln','Tempel-Kleidercode: Knie & Schultern bedeckt'], donts: ['Nie mit dem Fuß auf Stufen, Menschen oder Gegenstände zeigen','Den Kopf einer anderen Person anfassen','Das Königshaus kritisieren (strafbar in Thailand)','Mönche dürfen nicht von Frauen berührt werden'] },
  indonesisch:  { dos: ['Linke Hand beim Essen & Geben vermeiden (gilt als unrein)','In Tempeln Sarong und Schärpe tragen','Älteren Personen zuerst Respekt zeigen','Fotos immer erst fragen vor Aufnahme von Personen'], donts: ['Oben ohne an heiligen oder öffentlichen Orten','Schuhe nicht vor dem Betreten von Häusern ausziehen','Zeigefinger benutzen — stattdessen Daumen','Laut oder aggressiv bei Verhandlungen werden'] },
  arabisch:     { dos: ['Im Ramadan tagsüber nicht öffentlich essen oder trinken','Konservativ kleiden — Knie & Schultern bedeckt','Rechte Hand für Essen & Begrüßen verwenden','Vor dem Betreten von Häusern & Moscheen fragen'], donts: ['In Dubai/Abu Dhabi: kein Alkohol auf der Straße (verboten)','Zärtlichkeiten in der Öffentlichkeit vermeiden','Frauen nicht ohne ihre Zustimmung anfassen','Ärger oder Kritik niemals öffentlich zeigen'] },
  franzoesisch: { dos: ['Immer mit „Bonjour" in Läden & Restaurants begrüßen','Beim ersten Kontakt erst Französisch versuchen','Essen als soziales Erlebnis nehmen — nicht hetzen','Gepflegt gekleidet ins Restaurant gehen'], donts: ['In Paris nicht sofort Englisch sprechen ohne Versuch','Am Tisch nicht über Gehalt oder Geld reden','Nie Essen auf der Straße im Gehen','Nicht laut in Cafés & Museen unterhalten'] },
  spanisch:     { dos: ['Dinner-Zeit: 21–22 Uhr — vorher sind Restaurants leer','Siesta von 14–17 Uhr respektieren','Deux Wangenkuss zur Begrüßung bei Bekannten','Tapas-Kultur: Bestellen, teilen, genießen'], donts: ['Nie Katalanen als „Spanier" bezeichnen','Nicht ungeduldig sein — „mañana" ist Lebenskultur','Kein Tipp-Pflicht aber 5–10% ist üblich','Nie am frühen Abend ins Restaurant (vor 20:30)'] },
  italienisch:  { dos: ['Espresso nur im Stehen an der Bar — billiger & lokaler','Cappuccino nur bis 11 Uhr — nie nach dem Mittag!','Mittagspause 13–15 Uhr einplanen — Läden schließen','In Kirchen Schultern & Knie bedecken'], donts: ['Nie Parmesan auf Meeresfrüchte-Pasta bestellen','Nicht mit knapper Kleidung Kirchen betreten','Touristenfallen am Petersplatz & Trevi-Brunnen meiden','Nie an einem Touristenrestaurant mit Foto-Speisekarte essen'] },
  griechisch:   { dos: ['Nie mit flacher Hand winken — ist die „Moutza"-Beleidigung!','Ouzo & Raki werden zum Essen bestellt, nicht pur','Nachmittagspause 14–17 Uhr — dann ist alles ruhiger','In orthodoxen Kirchen immer bedeckt eintreten'], donts: ['Zypern-Konflikt oder türkische Politik ansprechen','Lautes Verhalten in kleinen Küstendörfern','Fotos in Kirchen ohne Erlaubnis machen','Das Licht in Kirchen und Kapellen anfassen'] },
  tuerkisch:    { dos: ['Schuhe vor dem Betreten von Moscheen ausziehen','Çay (Tee) annehmen — Ablehnung gilt als Unhöflichkeit','Auf Basaren ist Feilschen ausdrücklich erwünscht','Gastfreundschaft stets wertschätzen & erwidern'], donts: ['Mit Schuhsohlen auf Teppiche oder Sitzkissen treten','Politische Diskussionen mit Fremden beginnen','Kurdisch-Türkische Spannung ansprechen','Moscheen während der Gebetszeit touristisch besuchen'] },
  vietnamesisch:{ dos: ['Ältere Menschen zuerst mit Respekt begrüßen','Mit beiden Händen Gegenstände geben & nehmen','Schuhe vor dem Betreten von Tempeln ausziehen','Geister-Altäre in Shops & Häusern respektieren'], donts: ['Nie auf Geister-Altäre zeigen oder sie anfassen','Stäbchen niemals senkrecht im Reis stecken lassen','Bei Bezahlung nie Geld direkt auf den Tisch legen','Laut über politische Themen diskutieren'] },
  koreanisch:   { dos: ['Zwei Hände beim Geben & Nehmen von Gegenständen','Ältere Person am Tisch zuerst essen & trinken lassen','Schuhe ausziehen beim Betreten vieler Restaurants & Wohnungen','Soju & Bier gemeinsam genießen — Gläser gegenseitig nachfüllen'], donts: ['Nie selbst das eigene Glas nachfüllen — Gast nachfüllen lassen','Nie mit Rotstift Namen schreiben (Todesorakel-Tradition)','Öffentliche Diskussionen über Nordkorea meiden','Alter nicht erfragen — wird als unfreundlich empfunden'] },
  portugiesisch:{ dos: ['Fado-Shows in absoluter Stille genießen — kein Reden!','„Obrigado" (m) / „Obrigada" (f) korrekt verwenden','Pastéis de Nata noch warm, frisch aus der Bäckerei essen','Locals auf Portugiesisch ansprechen, nicht Spanisch'], donts: ['Portugiesisch mit Spanisch verwechseln oder gleichsetzen','Fado-Konzerte unterbrechen oder laut werden','Portugiesen mit Brasilianern gleichsetzen','Während des Fados das Handy zücken'] },
  usa:          { dos: ['Trinkgeld 18–25% in Restaurants — kein Spar-Tipp!','Small Talk mit Fremden ist normal & willkommen','Lächeln, Höflichkeit & Direktheit werden geschätzt','Supermarkt-Schlangen & Tür-halten sind Pflicht'], donts: ['Nie unter 15% Trinkgeld geben — gilt als Beleidigung','Witze über Flugzeug-Sicherheit im Flughafen sind verboten','Öffentlich Alkohol trinken (in den meisten Bundesstaaten illegal)','Über Religion oder Politik mit Fremden streiten'] },
};
